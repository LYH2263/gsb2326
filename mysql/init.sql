...
CREATE TABLE IF NOT EXISTS `cages` (
  ...
  `type` VARCHAR(50) DEFAULT NULL COMMENT '笼舍类型',
  `capacity` INT NOT NULL DEFAULT 1 COMMENT '最大容量',
...
-- 种子数据：笼舍
-- ========================================
INSERT INTO `cages` (`code`, `room`, `type`, `capacity`, `status`, `description`) VALUES
('A-101', 'A栋101室', '小鼠笼', 5, 'in_use', 'C57BL/6 系常规饲养笼'),
('A-102', 'A栋101室', '小鼠笼', 4, 'full', 'BALB/c 实验组饲养笼'),
('A-103', 'A栋102室', '小鼠笼', 5, 'in_use', 'ICR 常规饲养笼'),
('B-201', 'B栋201室', '大鼠笼', 4, 'in_use', 'SD 大鼠饲养笼'),
('B-202', 'B栋201室', '大鼠笼', 3, 'in_use', 'Wistar 大鼠饲养笼'),
('C-301', 'C栋301室', '兔笼', 2, 'in_use', '新西兰白兔饲养笼'),
('C-302', 'C栋301室', '兔笼', 2, 'in_use', '检疫兔舍'),
('D-401', 'D栋401室', '豚鼠笼', 4, 'in_use', '豚鼠饲养笼'),
('E-501', 'E栋501室', '小鼠笼', 5, 'idle', '备用空闲笼'),
('E-502', 'E栋501室', '大鼠笼', 4, 'maintenance', '维护中-清洗消毒');
